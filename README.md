...
Now that you know about all the details of the model, if you want to use it, just download the [**multi-modal transportation.py**](https://github.com/Yuvraj1507/Supply-Chain-Management-Analysis/blob/main/multi-modal%20transportation.py) & [**model data.xlsx**](https://github.com/Yuvraj1507/Supply-Chain-Management-Analysis/blob/main/model%20data.xlsx) in this repo. You can reset all the parameters' data in the excel file to fit your own case. After that, just run the python file and your **Solution.txt** will be generated!
